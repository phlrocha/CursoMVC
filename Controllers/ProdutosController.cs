...
namespace CursoMVC.Controllers
{
    public class ProdutosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Quantidade,CategoriaId")] Produto produto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Quantidade,CategoriaId")] Produto produto)
        {
            if (id != produto.Id)
            {
                return NotFound();
